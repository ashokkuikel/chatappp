<footer>
	<div class="row">
		<div class="col-md-4 col-sm-6 footer-navigation">
			<h3>
				<a href="#">Secure <span>Messaging </span></a>
			</h3>
			<p class="links">
				<a href="#">Home</a><strong> 
					...
					· </strong><a href="#">Contact</a>
			</p>
			<p class="company-name">Secure Messaging &copy; 2017</p>
		</div>
		<div class="col-md-4 col-sm-6 footer-contacts">
			...
			<div>
				...
				<p class="footer-center-info email text-left">+977 9860 463251</p>
			</div>
			<div>
				<i class="fa fa-envelope footer-contacts-icon"></i>
				<p>
					<a href="#" target="_blank">macrocloudtechnology@gmail.com</a>
				</p>
			</div>
		</div>
