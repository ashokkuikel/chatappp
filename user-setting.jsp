...
<body>
 ...
 <jsp:include page="inc/view/header_dash1.jsp"></jsp:include>
	...
	try {
		...
		String sql = "SELECT * FROM  new_registration where reg_email='" + UID + "'  ";
		
		
		ResultSet rec = cs.executeQuery(sql);
		if(rec != null) {
			rec.next();
                  ...
                  <form name="registration_form" id='registration_form' class="form-inline">
                    <div class="row">
                      <div class="form-group col-xs-6">
                        ...
                        <input id="firstname" class="form-control input-group-lg" type="text" name="txtName" size="20" value="<%=rec.getString("reg_name")%>" />
                      </div>
                      <div class="form-group col-xs-6">
